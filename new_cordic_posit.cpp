//different implementation of CORDIC with float
...
# define KPROD_LENGTH 33
    ...
    //',' << (sin_mathlib - y) / sin_mathlib  << ',' << x << ','<< cos_mathlib << ',' << (cos_mathlib - x) / cos_mathlib << ',' << y/x << ',' 
    //<< tan_mathlib << ',' << (tan_mathlib - y/x) / tan_mathlib << '\n'; 
