...
cordic_posit: cordic_posit.cpp
    #g++ -Wall -fdiagnostics-color=never -Werror -fsanitize=address -o cordic cordic_float.cpp 
    g++ -std=gnu++11 -Wall -fdiagnostics-color=never -Werror -o cordic_posit cordic_posit.cpp ../SoftPosit/build/Linux-x86_64-GCC/softposit.a -I../Softposit/sourceinclude -O2
